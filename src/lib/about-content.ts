...
export const GALLERY_PROMO = {
  ...
  artPalUrl: 'https://www.artpal.com/sukh2',
  paragraphs: [
    'Sukh D. H. Khokhar, a supernatural mystery writer, poet, and illustrator based in Calgary, Alberta, invites you to tour her spellbinding art gallery, which will leave you feeling breathless. She is a talented multimedia mural artist who specializes in creating artwork that blends historical and mystical perspectives. She has launched her stunning online art gallery encompassing more than 200 amazing pieces of art, highlighting her unique style of combining bold, supernatural imagery with lyrical and magical elements. The way she presents her artwork is spectacular. Her exploration of supernatural entities—like angels, fairies, ghosts, and demons—goes beyond the ordinary into a fascinating realm of magical realism and mystical art.',
    'Her artwork is mesmerizing, immersive, and profound. It has an enduring, haunting quality that resonates quickly with the deeper recesses of one’s mind and soul. Every painting, every detail has a haunting, magical quality. She has the ability to transform the ordinary into the extraordinary, much like her ability to turn her curses into blessings and her obstacles into opportunities.',
    ...
    'Dark Mystery: Spellbound—Arose from the Ashes tells the story of an angel, disguised as a prince, who is transformed into a ghost by a jealous demon and trapped in time. His remorse, perseverance and faith help him reconnect with the higher source and empower him to transcend the barriers of time and space to reunite with his true love, Princessa. The book is a poetic rendition of a story from the author’s debut historical novel, The Mystery of the Rose—The Return of the Prince, which was nominated for the 2013 Crossword Book Award.',
    'The metaphors and imagery in her paintings are diverse, overwhelming, and extraordinary—deeply meaningful and relevant, especially in today\'s world where people\'s interests are shifting toward content that explores the unknown and challenges the norms of conventional thinking. Her ability to tell stories by seamlessly braiding and weaving the mystical with real-world relevance is commendable. It is as if she has tapped into the collective curiosity about the supernatural that is so prevalent today. The way she delves into the mysterious and supernatural aspects of these phenomena is an exhilarating experience.',
    'Her portrayal of these spiritual beings, especially focusing on their darker and malevolent natures, is deeply moving.',
    'I urge everyone to take a tour of her gallery, buy a piece, or gift one to someone. It will be a one-of-a-kind, profound experience to feel the spirit of this powerful artist coming through the artwork.',
  ],
};
