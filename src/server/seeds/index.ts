  ...
  const pages = [
    {
      ...
      sections: [
        ...
        createSection({
          ...
          description: 'Sukh D. H. Khokhar is a mystery writer, mural artist, and visual storyteller whose work weaves together narrative intrigue and bold artistic expression. With nearly 200 mystical paintings in his collection, each piece invites viewers into a world of imagination and wonder.',
    ...
    },
    {
      ...
      sections: [
        createSection({ sectionKey: 'hero', sectionType: 'hero', label: 'Hero', heading: 'The Artist Behind the Mystery', eyebrow: 'About', layout: 'cinematic', order: 0 }),
        createSection({ sectionKey: 'introduction', sectionType: 'content', label: 'Introduction', heading: 'A Life of Art and Storytelling', description: 'Sukh D. H. Khokhar brings together the worlds of mystery writing, mural artistry, and visual storytelling in a body of work that captivates and inspires.', order: 1 }),
        createSection({ sectionKey: 'mystery-writer', sectionType: 'content', label: 'Mystery Writer', heading: 'The Mystery Writer', description: 'Words and images intertwine in Sukh\'s creative practice. As a mystery writer, he crafts narratives that echo the intrigue found in his paintings — each story a doorway into another realm of imagination.', order: 2 }),
        createSection({ sectionKey: 'mural-artist', sectionType: 'content', label: 'Mural Artist', heading: 'The Mural Artist', description: 'Transforming walls into canvases of wonder, Sukh creates large-scale murals that bring mystical imagery into public and private spaces.', order: 3 }),
        createSection({ sectionKey: 'philosophy', sectionType: 'content', label: 'Artistic Philosophy', heading: 'Artistic Philosophy', description: 'Art should provoke curiosity, evoke emotion, and invite the viewer to become part of the story. Every brushstroke carries intention; every colour holds meaning.', order: 4 }),
        createSection({ sectionKey: 'process', sectionType: 'content', label: 'Creative Process', heading: 'The Creative Process', description: 'From initial sketch to final varnish, each piece undergoes a journey of exploration — layers of paint building narratives that reveal themselves over time.', order: 5 }),
        createSection({ sectionKey: 'studio', sectionType: 'gallery', label: 'Studio Collage', heading: 'Behind the Scenes', layout: 'collage', order: 6 }),
        createSection({ sectionKey: 'timeline', sectionType: 'timeline', label: 'Timeline', heading: 'Milestones', layout: 'vertical-timeline', order: 7 }),
        createSection({ sectionKey: 'contact-cta', sectionType: 'cta', label: 'Contact CTA', heading: 'Connect with the Artist', buttonText: 'Contact Sukh', buttonUrl: '/contact', order: 8 }),
      ],
    },
    {
      pageKey: 'services',
  ...
  await Testimonial.insertMany([
    {
      ...
      review: 'Sukh\'s mystical paintings have transformed our living space. Each piece tells a story that draws you in and keeps you captivated. The quality and attention to detail are extraordinary.',
      rating: 5,
      isFeatured: true,
      displayOrder: 0,
    },
    {
      ...
      review: 'Working with Sukh on a custom mural for a client\'s restaurant was an incredible experience. His ability to translate a concept into a breathtaking visual narrative is unmatched.',
      rating: 5,
      isFeatured: true,
      displayOrder: 1,
    },
    {
      ...
      customerTitle: 'Gallery Owner',
      review: 'The depth and mystery in Sukh\'s work resonates with our gallery visitors. His paintings consistently generate the most engaging conversations and admiration.',
      rating: 5,
      isFeatured: true,
      displayOrder: 2,
    },
    {
      ...
      review: 'I commissioned a piece for my study and the result exceeded every expectation. Sukh\'s collaborative approach made the entire process enjoyable and the artwork is simply stunning.',
      rating: 5,
      isFeatured: false,
      displayOrder: 3,
    },
  ...
  await BlogPost.insertMany([
    {
      ...
      categories: ['Creative Process', 'Mystery'],
